...
import {
  pjsua_100rel_use, pjsua_acc_id,
  pjsua_call_hold_type, pjsua_ipv6_use,
  pjsua_nat64_opt,
  pjsua_sip_timer_use,
  pjsua_stun_use
...
/**
 * This interfaceure contains parameters for onIncomingCall() account callback.
 */
...
/**
 * This interfaceure contains parameters for onRegStarted() account callback.
 */
...
/**
 * This interfaceure contains parameters for onRegState() account callback.
 */
...
/**
 * This interfaceure contains parameters for onIncomingSubscribe() callback.
 */
...
export interface Account {
   ...
   * call this method in the beginning stage in its deinterfaceor, or
   ...
   * the derived class deinterfaceor and Account callbacks.
   */
  shutdown (): void;
   ...
   */
  setOnlineStatus (pres_st: PresenceStatus): void;
   ...
   */
  setTransport (tp_id: TransportId): void;
   ...
   */
  presNotify (prm: PresNotifyParam): void
   ...
   *
   * @deprecated !DEPRECATED_FOR_TICKET_2232
   ...
   */
  _onIncomingCall (prm: OnIncomingCallParam): void
   ...
   * @param prm      Callback parameter.
   */
  onRegStarted (prm: OnRegStartedParam): void
   ...
   * @param prm      Callback parameter.
   */
  onIncomingSubscribe (prm: OnIncomingSubscribeParam): void
   ...
   * @param prm      Callback parameter.
   */
  onInstantMessageStatus (prm: OnInstantMessageStatusParam): void
   ...
   * @param prm      Callback parameter.
   */
  onTypingIndication (prm: OnTypingIndicationParam): void
   ...
   * @param prm      Callback parameter.
   */
  onMwiInfo (prm: OnMwiInfoParam): void
}
...
//     super()
//
//     DeviceEventEmitter.addListener('_onIncomingCall', this._onIncomingCall.bind(this))
//   }
//
//     /**
//      * Create the account.
//      *
//      * If application implements a derived class, the derived class should
//      * call shutdown() in the beginning stage in its deinterfaceor, or
...
//      */
//     static create(cfg:AccountConfig, make_default:false)
//
//     /**
//      * Shutdown the account. This will initiate unregistration if needed,
//      * and delete the corresponding account in the PJSUA-LIB.
...
//      * @param pres_st		Presence online status.
//      */
//     public setOnlineStatus(pres_st:PresenceStatus):void;
//
//     /**
//      * Lock/bind this account to a specific transport/listener. Normally
//      * application shouldn't need to do this, as transports will be selected
